    ...
    return (
        <>
            <ConfirmDialog
                ...
                content={`¿Estás seguro de que deseas eliminar la orden: "${orderToDelete}"?`}
            ...
            <PageHeader
                ...
                buttons={[
                    { onClick: () => navigate({ to: '/proveedores/ordenes-de-compra/crear-ordenes-de-compra' }), text: 'Crear Orden de Compra' }
                ]}
            />
            <FilterOptions
